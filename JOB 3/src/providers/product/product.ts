...
export class ProductProvider {
  ...
  public update(product: Product){
    ...
    .then((db: SQLiteObject) => {
      ...
      let params = [product.name, product.price, product.duedate, product.active ? 1 : 0, product.category_id, product.id];
        return db.executeSql(sql, params)
        .then(() => console.log('Produk berhasil diubah!'))
        .catch(e => console.error('Produk gagal diubah:', e))
    })
    .catch((e) => console.error(e));
  }
  ...
  public get(id: number){
    ...
    .then((db: SQLiteObject) => {
      ...
      .catch(e => console.error('Produk gagal diambil: ', e));
    })
    .catch((e) => console.error(e));
  }
