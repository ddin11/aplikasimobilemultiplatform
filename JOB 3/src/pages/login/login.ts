...
export class LoginPage {
  ...
  constructor(public navCtrl: NavController, private userProvider: UserProvider, private platform: Platform, private toastController: 
    ToastController) {
...
this.userProvider.validateUserAccount(this.newUser.username, this.newUser.password).then(userAccount => {
  if(userAccount != null){
    ...
    this.showToast("Username and password not available, plis sign up!");
  }
});
}
