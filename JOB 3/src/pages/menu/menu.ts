...
export class MenuPage { 
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public navCtrl: NavController, public navParams: NavParams, public alerCtrl: AlertController, public databaseProvider: DatabaseProvider) {     this.initializeApp();     
  ...
  openPage(page) {    
    this.nav.setRoot(page.component, {menuAccount: this.userAccount});   
  } 
