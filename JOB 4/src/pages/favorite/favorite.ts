...
@Component({
selector: 'page-favorite', templateUrl: 'favorite.html',
})
...
ionViewDidLoad() { console.log('ionViewDidLoad FavoritePage');
}

ionViewDidEnter(){ this.getAllFavoriteProduct();
}
...
message: 'Product favorite telah dihapus.', duration: 3000,
position: 'bottom'
}).present();
});
}

filterFavoriteProducts(ev: any){ this.getAllFavoriteProduct();
}
